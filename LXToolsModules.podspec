...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LXToolsModules.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ccsxlx@163.com/LXToolsModules'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ccsxlx@163.com' => 'lei.xiangxiang@yinchengku.com' }
  s.source           = { :git => 'https://github.com/ccsxlx@163.com/LXToolsModules.git', :tag => s.version.to_s }
